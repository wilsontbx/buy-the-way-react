    ...
    <React.Fragment>
      <Paper style={{ maxWidth: "500px", margin: "0 auto" }}>
          ...
          (category === "Food" ? (
            <React.Fragment>
              <Grid item xs={6} className={classes.item}>
                ...
                >
                  <MenuItem value={"Requires Chilling?"}>
                    Requires Chilling?
                  </MenuItem>
              ...
              <Grid item xs={6} className={classes.item}>
                ...
                >
                  <MenuItem value={"Is there expiry?"}>
                    Is there expiry?
                  </MenuItem>
              ...
              <Grid item xs={6} className={classes.item}>
                ...
                >
                  <MenuItem value={"Requires Special Handling?"}>
            ...
            <Grid className={classes.item} item xs={12} sm={6} md={3}>
              ...
              >
                {" "}
                <MenuItem value={"Is item Fragile??"}>
                  Is item fragile?
                </MenuItem>
                <MenuItem value={"Yes"}>Yes</MenuItem>
                <MenuItem value={"No"}>No</MenuItem>
        ...
        <Dialog open={open} onClose={handleClose}>
          <Grid item>
            <Typography variant="h5"> Please confirm your pre-order</Typography>
